...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2200 (incl. 1492 user, 662 helpers, 14 vtables, 32 lits); src size 0
; assembly: 1461 lines; density: 746 bytes/stmt; (2 stmts)
; total bytes: 288920 (55.1% of 512.0k flash with 235368 free)
...
; start
    ...
    .hex 06354AC8E3F7D1E5 ; hex template hash
